    ...
    <section id="contato" className="w-full min-h-screen flex justify-center items-center relative max1000:flex-col" data-aos="zoom-in-up" data-aos-duration="1500">
      <div className="mt-16 flex items-center justify-center flex-col">
        ...
        <div className="flex flex-col justify-center items-center gap-4 border-2 border-light-coral border-dashed rounded-lg p-4 mt-4">
            ...
            <a href="https://www.linkedin.com/in/alexandre-dsilva/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-x-2 rounded-lg p-1 hover:bg-primary-blue hover:text-light-coral transition-all ease-in-out duration-700">
              <FiLinkedin className="text-2xl" />
              <span className="text-xl">/alexandredasilva</span>
            </a>
            </div>

            <div className="flex items-center justify-center">
             <span className="text-x1 pr-2 max550:hidden">No Instagram: </span>
              <a href="https://www.instagram.com/_alexandredsilva/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-x-2 rounded-lg p-1 hover:bg-primary-blue hover:text-light-coral transition-all ease-in-out duration-700">
              <FiInstagram className="text-2xl" />
              <span className="text-xl">/alexandredsilva</span>
              </a>
            </div>

            <div className="flex items-center justify-center">
            <span className="text-x1 pr-2 max550:hidden">Por Email: </span>
            <a href="mailto:506dasilva@gmail.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-x-2 rounded-lg p-1 hover:bg-primary-blue hover:text-light-coral transition-all ease-in-out duration-700">
            ...
            <a href="https://github.com/D4SiLv4" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-x-2 rounded-lg p-1 hover:bg-primary-blue hover:text-light-coral transition-all ease-in-out duration-700">
            <FiGithub className="text-2xl" />
            <span className="text-xl">alexandre</span>
          </a>
            </div>
          <span className="max550:hidden">Ou, se preferir, me mande uma mensagem no WhatsApp: </span>
          <a href="https://api.whatsapp.com/send?phone=556796908822&text=Oi,%20Thiago.%20Estou%20entrando%20em%20contato%20atrav%C3%A9s%20do%20seu%20site%20de%20portf%C3%B3lio." 

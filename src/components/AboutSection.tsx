  ...
  return (
    <section id="sobre" className="flex w-full min-h-screen items-center justify-center gap-x-20 max1070:flex-col-reverse" data-aos="zoom-in-up">
      ...
      <div className="flex flex-col items-center justify-center w-[600px] text-center gap-y-5 mt-14 max675:w-[550px] max620:w-[500px] max550:w-[450px] max480:w-[400px] max425:w-[350px] max425:gap-y-2 max375:w-[300px]">
        ...
        <p className="text-[1.1rem] tracking-wide max700:text-[1rem] max700:tracking-[0px] max425:text-[15px] max400:text-[14px]">Meu nome é Alexandre, tenho 25 anos e atualmente estou cursando o segundo semestre de Segurança da Informação. Sou um entusiasta dedicado à cibersegurança, sempre em busca de novos conhecimentos e habilidades na área.</p>
        <p className="text-[1.1rem] tracking-wide max700:text-[1rem] max700:tracking-[0px] max425:text-[15px] max400:text-[14px]">Estou comprometido em me tornar um profissional altamente capacitado para proteger sistemas e dados contra ameaças cibernéticas, contribuindo para a segurança e integridade das informações nas organizações.</p>
        <SocialMediaLinkAlt
